...
\section{Question 1.3.5}
Verify $$\brak{\vec{A}-\vec{H}}^{\top}\brak{\vec{B}-\vec{C}}=0$$
\begin{figure}
\centering
...
\vec{C}&=\myvec{-3\\-5}
\end{align}
Also,we have a point $\vec{H}=\myvec{\frac{17}{6}\\\frac{-5}{6}}$ \\
...
To verify answer:
\begin{align}
\brak{\vec{A}-\vec{H}}^{\top}\brak{\vec{B}-\vec{C}}&=\myvec{\frac{-11}{6}\\\frac{-1}{6}}^{\top}\myvec{-1\\11}\\
&=\myvec{\frac{-11}{6}&\frac{-1}{6}}\myvec{-1\\11}\\
&=0
\end{align}
Hence,verified.
